...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
    	...
    	return cardAdventurer(currentPlayer, drawntreasure, &cardDrawn, temphand, state);
			
    case council_room:

		return cardCouncil_room(currentPlayer, handPos, state);
    ...
    case remodel:
    	...
    	return cardRemodel(currentPlayer, choice1, choice2, handPos, state);
	...
	**********************************************************************************/	
    case smithy:
    	return cardSmithy(currentPlayer, handPos, state);
...
int cardAdventurer(int currentPlayer, int drawntreasure, int *cardDrawn, int *temphand, struct gameState *state){
  int z = 0;
...
int cardCouncil_room(int currentPlayer, int handPos, struct gameState *state){
	int i;
      //+4 Cards
      for (i = 0; i < 4; i++)
	{
